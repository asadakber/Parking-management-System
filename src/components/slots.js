...
class Slots extends Component{
    ...
    render(){
        ...
        return(
            <div>
                {      
                    this.state.booking ? <Paper style={{background: 'grey', opacity: 0.9, height: '100px', lineHeight: '100px', marginTop: '150px', color: '#FFF'}} zDepth={3}><h1>Successfully booked Slot No {this.state.slotClick}</h1></Paper> : 
                    <div>
                    <Paper style={styles.Paper} zDepth={5}>
                        <h1 style={{color: '#FFFFFF'}}>Select Timing</h1>
                        ...
                        <span style={{top: '-20px', position: 'realtive', color: '#FFFFFF'}}>Start Time:</span>
                        <span className='row'>
                            ...
                            <span style={{top: '-20px', position: 'realtive', color: '#FFFFFF'}}>Select Hours:</span>
                        <span className='row'>
                        ...
                        <RaisedButton onClick={this.submitButton} label="Book Slot" /> 
                        </div>
                    </Paper>
                    <h1 style={{color: '#263238'}}>Slots:</h1>
                    {
                        this.state.toggleSlots ? <div>
                            {
                                this.state.slots.map((slot, index) => <button style={{backgroundColor: 'grey', borderWidth: 1, borderColor: '#000', borderStyle: 'solid' ,  color: '#FFF', opacity: 0.9, marginLeft: 10,}} className={slot.booking ? 'bookingTrue' : 'bookingFalse'} onClick={(e)=> {e.preventDefault(); this.slotClick(index, slot.booking)}} key={index}>slot{+ index}</button>)                            
                            }
                        </div> : ''
                    }
                </div>
